...
public class HJ22 {
    ...
    public static void main(String[] args) {
        ...
        while (sc.hasNext()) {
            ...
            while (kong > 1) {
                if (kong > 3) {
                    // kong 瓶子可换 temp_vaild_num 个汽水 10 / 3 = 3
                    int temp_vaild_num = kong / 3;
                    // 换完之后剩下 10 % 3 = 1 + 喝完的空瓶子 3 + 1 = 4
                    kong = kong % 3 + temp_vaild_num;
                    // 总共喝的水 0 + 3 = 3
                    vaild_num += temp_vaild_num;
                } else {
                    vaild_num++;
                    kong = 0;
                }
            }
            System.out.println(vaild_num);
        }
    }
}
